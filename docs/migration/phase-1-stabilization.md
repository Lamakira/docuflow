...
| G9 | A restart attestation and a rotation attestation, recorded without the secret or any material derived from it. | [#56](https://github.com/Lamakira/docuflow/issues/56) |
...
The production-oriented desktop release workflow is a separate ADR-0018 architecture conflict, not a gate, and is not reassigned by ADR-0020. It carries its own disposition ticket, [#60](https://github.com/Lamakira/docuflow/issues/60). This record does not elevate it into an additional Phase 1 gate.
