...
| Every defect filed, and split into blocking and degrading | **Met** | 3 blocking (B1, B2, B3), all fixed in this branch and covered by tests. 4 filed as issues: [#236](https://github.com/Lamakira/docuflow/issues/236), [#237](https://github.com/Lamakira/docuflow/issues/237), [#238](https://github.com/Lamakira/docuflow/issues/238), [#239](https://github.com/Lamakira/docuflow/issues/239). 4 v2 interface findings live in [`UI-FINDINGS.md`](../web-app-v2/UI-FINDINGS.md) (F1–F4), which is where a reader of a v2 screen will meet them; D1–D3 are this record's pointers to F1–F3 and are not separate defects. The audit of 18 unscoped storage methods is a spec, not a defect, and is written up above |
