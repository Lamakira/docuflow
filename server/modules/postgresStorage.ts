/**
 * Combined postgres adapter for every domain persistence interface (#113).
 * Later Phase 6 tickets extract implementations into their modules.
 * HTTP still reaches this through `server/storage.ts`.
 */
